...
<html>
    ...
    <body>
        <div class="b-container">
            ...
            <div class="container"> 
                <p style="color:blue; font-size:20px;"><marquee>Your Adding items in store!!!!!!</marquee></p>			
                <fieldset  style="border-color:#CC9933;margin-left:30px; margin-right:70px;"class="fieldset" >
                    <legend style="color:blue; background-color:gold;border-radius:5px;"><span style="margin-left:20px;">ADD PRODUCTS IN STORE</legend>

                    <form action="submit.php" method="post" class="b-container">
                        <table class="table">
                            <tr>
                                <td><label>PRODUCT NAME</label></td>
                                <td><input name="pname" id="pname" type="text" style="padding:5px 54px;color:white;margin-left:35%;" placeholder="Item_name" style="width:100%;"></td>
                            </tr>
                            <tr>
                                <td><label>SIMPLE DESCRIPTION</label></td>
                                <td><input name="description" id="description" type="text" style="padding:5px 54px;color:white;margin-left:35%;" placeholder="Item description" style="width:100%;"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input name="date" id="date" type="DATE" style="padding:5px 64px;color:white;margin-left:35%;" placeholder="Date" style="width:100%;" ></td>
                            </tr>
                            <tr>
                                <td><label>BUYING PRICE</label></td>
                                <td><input  name="b_price" id="b_price" type="number" style="padding:5px 54px;color:white;margin-left:35%;" placeholder="Buying Price" style="width:100%;"></td>
                            </tr>
                            <td><label>ADDED BY</label></td>
                            <td><input name="additem" id="additem" type="text" style="padding:5px 54px;color:white;margin-left:35%;" placeholder="----Select---" style="width:100%;" ></td>
                            </tr>
                        </table>
                        <button type="btn btn-success" name="Input" style="padding:10px 20px; background-color:gold; margin-left:70%"   onClick="validate()" >Add Item</button>
                    </form>
                </fieldset>
            </div>
