...
<body>
	<div class="b-container">
		...
		<div class="row">
			...
			<div class="container"> 
				<p style="color:blue; font-size:20px;"><marquee>Your Registering new clients!!!!!!</marquee></p>			
				<fieldset  style="border-color:#CC9933;margin-left:50px;margin-right:70px;" class="b-container">
					
					<legend style="color:blue; background-color:gold;border-radius:5px;"><span style="margin-left:20px;">CLIENT REGISTRATION FORM</legend>
						...
						<table class="table" >
						  ...
						  <tr>
						   ...
						   <tr>
							<td><label>CONTACT</label></td>
							  <td><input name="phone" id="phone" type="number" style="padding:5px 54px;color:white;margin-left:25%;" placeholder="phonenumber" style="width:100%;" ></td>
						  </tr>
						  <tr>
						  ...
						  <tr>
							<td><label>OCCUPATION</label></td>
							  <td><input type="text" name="job" id="job" style="padding:5px 54px;color:white;margin-left:25%;"  placeholder="Occupation" style="width:100%;"></td>
						  </tr>
						  <tr>
						  ...
						  <tr>
							<td><label>CLIENT CATEGORY</label></td>
							  <td><input name="c_type" id="c_type" type="text" style="padding:5px 54px;color:white;margin-left:25%;" placeholder="---Select---" style="width:100%;" ></td>
						  </tr>
						  <tr>
							<td><label>INQUIRELY</label></td>
							  <td><input name="inquirely" id="inquirely" type="text" style="padding:5px 54px;color:white;margin-left:25%;" placeholder="Inquirely" style="width:100%;" ></td>
						  </tr>
						  <tr>
						   <td><label>REGISTERED BY</label></td>
							  <td><input name="registered" id="registered" type="text" style="padding:5px 54px;color:white;margin-left:25%;" placeholder="----Select---" style="width:100%;" ></td>
						  </tr>
					  
						</table>
					  <input type="submit" name="Input" style="padding:10px; background-color:gold; margin-left:65%"  value="submit Details" onClick="validate()" >
					  </form>
					</fieldset>
					</div>
